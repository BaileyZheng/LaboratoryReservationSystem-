...
<div class="xzfw" style="width: 210px;">
    <div class="xzfw_nav" style="width:214px;min-height:500px;">
        <div class="nBox" style="width:214px;">
            ...
            <div class="sm">
				<dl class="">
                    <dt><a class="xxfb" href="${pageContext.request.contextPath }/xwgg/info_toListXWDT.action" target="mainFrame"><b></b>新闻动态<s class="down"></s>
                    </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="xxfb" href="${pageContext.request.contextPath }/xwgg/info_toListTZGG.action" target="mainFrame"><b></b>通知公告<s class="down"></s>
                    </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="xxfb" href="${pageContext.request.contextPath }/xwgg/info_toListGZZD.action" target="mainFrame"><b></b>规章制度<s class="down"></s>
                    </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="xxfb" href="${pageContext.request.contextPath }/xwgg/info_toListSWZL.action" target="mainFrame"><b></b>失物招领<s class="down"></s>
                    </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="xxfb" href="${pageContext.request.contextPath }/xwgg/info_toListXWQS.action" target="mainFrame"><b></b>寻物启事<s class="down"></s>
                    </a></dt>
                </dl>
            </div>
        </div>
