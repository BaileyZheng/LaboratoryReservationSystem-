...
<div class="xzfw" style="width: 210px;">
    <div class="xzfw_nav" style="width:214px;min-height:500px;">
        <div class="nBox" style="width:214px;">
            ...
            <div class="sm">
				<dl class="">
                    <dt><a class="yh" href="${pageContext.request.contextPath }/skgl/home_skgxwh.action" target="mainFrame"><b></b>授课关系维护<s class="down"></s>
                    </a></dt>
                </dl>
                <dl class="">
                    <dt><a class="yh" href="${pageContext.request.contextPath }/skgl/home_skgcgl.action" target="mainFrame"><b></b>授课过程管理<s class="down"></s>
                    </a></dt> 
                </dl>
            </div>
        </div>
