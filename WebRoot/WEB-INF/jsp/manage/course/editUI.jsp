...
<form id="form" name="form" action="${basePath }manage/course_saveEdit.action" method="post" enctype="multipart/form-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
            <div class="content_info">
    <div class="c_crumbs"><div><b></b><strong>课程管理</strong>&nbsp;-&nbsp;编辑课程</div></div>
    <div class="tableH2">编辑课程</div>
