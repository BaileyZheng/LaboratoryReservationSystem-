...
<form id="form" name="form" action="${basePath }manage/clazz_add.action" method="post" enctype="multipart/form-data">
    <div class="p_d_1">
        <div class="p_d_1_1">
            <div class="content_info">
    <div class="c_crumbs"><div><b></b><strong>班级管理</strong>&nbsp;-&nbsp;新增班级</div></div>
    <div class="tableH2">新增班级</div>
