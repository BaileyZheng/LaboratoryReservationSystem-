...
<head>
	...
	function doSelectAll(){
  	...
  	//新增
  	function doAdd(){
  		document.forms[0].action = "${basePath}manage/role_addUI.action";
  		document.forms[0].submit();
  	}
  	//编辑
  	function doEdit(id){
  		document.forms[0].action = "${basePath}manage/role_editUI.action?role.roleId=" + id;
  		document.forms[0].submit();
  	}
  	//删除
  	function doDelete(id){
  		document.forms[0].action = "${basePath}manage/role_delete.action?role.roleId=" + id;
  		document.forms[0].submit();
  	}
  	//批量删除
  	function doDeleteAll(){
  		document.forms[0].action = "${basePath}manage/role_deleteSelected.action";
  		document.forms[0].submit();
  	}
	var list_url="${basePath}manage/role_listUI.action";
  	function doSearch(){
  		$("#pageNo").val(1);
