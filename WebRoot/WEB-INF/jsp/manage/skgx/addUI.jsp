...
<form id="form" name="form" action="${pageContext.request.contextPath }/manage/teach_add.action" method="post">
    <div class="p_d_1">
        <div class="p_d_1_1">
            <div class="content_info">
    <div class="c_crumbs"><div><b></b><strong>授课关系管理</strong>&nbsp;-&nbsp;新增授课关系</div></div>
    <div class="tableH2">新增授课关系</div>
