...
<div class="xzfw" style="width: 210px;">
    <div class="xzfw_nav" style="width:214px;min-height:500px;">
        <div class="nBox" style="width:214px;">
            ...
            <div class="sm">
				<dl class="">
                    <dt><a class="sys" style="cursor: pointer;"><b></b>实验室介绍<s class="down"></s>
                    </a></dt>
                    <dd id="fwyygl" style="display:none;">
                        <a class="" href="${pageContext.request.contextPath }/cgzs/home_room.action?type=jf" target="mainFrame"><b></b>机房</a>
                        <a class="" href="${pageContext.request.contextPath }/cgzs/home_room.action?type=dqsys" target="mainFrame"><b></b>电气实验室</a>
                    </dd>
                </dl>
                <dl class="">
                    <dt><a class="yh" href="${pageContext.request.contextPath }/cgzs/home_student.action" target="mainFrame"><b></b>风采展示<s class="down"></s>
                    </a></dt>
                </dl>
            </div>
        </div>
