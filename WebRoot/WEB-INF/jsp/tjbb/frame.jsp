...
<head>
    <base href="<%=basePath%>">
    <title>江苏科技大学实验室预约系统-统计报表</title>
...
<frameset cols="*,1222,*" class="bj" frameborder="no" border="0" framespacing="0">
    ...
    <frameset rows="156,*" cols="*" frameborder="no" border="0" framespacing="0">
        <frame src="${basePath }tjbb/home_top.action" name="topFrame" scrolling="No" noresize="noresize" id="topFrame" />
        <frameset cols="14%,60%" frameborder="no" border="0" framespacing="0">
            <frame src="${basePath }tjbb/home_left.action" scrolling="yes" noresize="noresize" id="leftFrame" />
            <frame src="${basePath}tjbb/home_room.action" name="mainFrame" id="mainFrame" />
        </frameset>
    </frameset>
    <frame src="${basePath}common/bg.jsp" scrolling="No" noresize="noresize"/>
</frameset>
