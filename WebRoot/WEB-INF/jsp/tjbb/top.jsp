	...
	<div class="banner">
		<div class="menu">
			<ul class="clearfix">
		        ...
		        <c:if test="${SYS_ADMIN!=null}"><li><a href="${basePath}manage/home_frame.action" target="_top">数据管理</a> </li></c:if>
		        <c:if test="${SYS_TEACHER!=null}"><li><a href="${basePath}skgl/home_frame.action" target="_top">授课管理</a> </li></c:if>
		        <li class="hover"><a href="${basePath}tjbb/home_frame.action" target="_top">统计报表</a> </li>
